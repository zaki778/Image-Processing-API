...
var checker = function (req, res, next) {
    ...
    (0, file_exists_1.default)("resizedImages/".concat(completedFileName, ".jpg"), function (err, exists) { return __awaiter(void 0, void 0, void 0, function () {
        var ret, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    next();
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, (0, resizeFunc_1.resize)(fileName, w, h)];
                case 2:
                    ret = _b.sent();
                    if (ret)
                        next();
